...
* Ported from Crazy Climber arcade game by Nihon Bussan Co. Ltd., 1980.
* TI-99/4A version by Rasmus Moustgaard, 2025.

## Requirements

* TI-99/4A with 32K RAM expansion
* Ability to load a 128K ROM cartridge, e.g. physical cartridge or FinalGROM99
...
* Requires xdt99 assembler (https://github.com/endlos99/xdt99) and Java
* Run make.bat (only supported on Windows)
...
Please post comments or questions at: https://forums.atariage.com/topic/383261-crazy-climber
